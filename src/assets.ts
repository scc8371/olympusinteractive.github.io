...
import logo_no_background from './assets/logos/logo_no_background.png'
import logo_pantheon from "./assets/logos/pantheon.webp"

import placeholder_person from "./assets/placeholder/person_placeholder.png"
...
import nebulicious_gif from "./assets/game-img/nebulicious.gif"
import icarus_gif from "./assets/game-img/icarus.gif"
import karnissa_gif from "./assets/game-img/karnissa.gif"
import doodle_gif from "./assets/game-img/doodleday.gif"

export default {
    "logo" : logo,
    "logo-no-background": logo_no_background,
    "logo-pantheon": logo_pantheon,


    "ninjas-gif": ninjas_on_trampolines_gif,
    "helpless-gif": helpless_gif,
    "nebulicious-gif": nebulicious_gif,
    "icarus-gif": icarus_gif,
    "karnissa-gif": karnissa_gif,
    "doodle-gif": doodle_gif,
